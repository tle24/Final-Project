...
For this project, the Diabetes Health Indicators Dataset will be explored to see if there is a relationship between some variables and those with diabetes or prediabetes. This EDA will look at three variables in particular: high blood pressure, high cholesterol, and if there has been any physical activity in the past 30 days.
